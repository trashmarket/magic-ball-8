...
const TEMPLATE_ID = "ball";
const BALL_TRIANGLE = "ball__triangle";
const BALL_TRIANGLE_ACTIVE = "ball__triagle_active";
const BALL_CLOSE_ICONE = "ball__close-icon";
const BALL_FORM = "ball__form";
const BALL_FORM_ACTIVE = "ball__from_active";
